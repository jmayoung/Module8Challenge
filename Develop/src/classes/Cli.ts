    ...
    inquirer
      ...
      .then((answers) => {
        ...
        if (answers.vehicleType === 'Truck') {
          console.log("Truck unable to tow itself");
        } else { 
          ...
          .prompt([
            {
              type: 'list',
              name: 'towTruckAction',
              message: 'Select an action for the tow truck',
              choices: [
                'Park the tow truck',
                'Refuel the tow truck',
                'Perform maintenance on the tow truck',
                'Return to main menu',
              ],
            },
          ])
          .then((actionAnswers) => {
            switch (actionAnswers.towTruckAction) {
              case 'Park the tow truck':
                console.log('The tow truck has been parked');
                break;
              case 'Refuel the tow truck':
                console.log('The tow truck has been refueled');
                break;
              case 'Perform maintenance on the tow truck':
                console.log('Maintenance has been done on the truck');
                break;
            ...
            // After performing an action, allow the user to select another action
            this.performActions();
          });
      });
  }
